// Assignment2_mm_interconnect_1.v
...
`timescale 1 ps / 1 ps
module Assignment2_mm_interconnect_1 (
		...
		input  wire         hps_clk_reset_reset_bridge_in_reset_reset,                        //                        hps_clk_reset_reset_bridge_in_reset.reset
		input  wire         hps_master_translator_reset_reset_bridge_in_reset_reset,          //          hps_master_translator_reset_reset_bridge_in_reset.reset
		input  wire [31:0]  hps_master_address,                                               //                                                 hps_master.address
		output wire         hps_master_waitrequest,                                           //                                                           .waitrequest
		input  wire [3:0]   hps_master_byteenable,                                            //                                                           .byteenable
		input  wire         hps_master_read,                                                  //                                                           .read
		output wire [31:0]  hps_master_readdata,                                              //                                                           .readdata
		output wire         hps_master_readdatavalid,                                         //                                                           .readdatavalid
		input  wire         hps_master_write,                                                 //                                                           .write
		input  wire [31:0]  hps_master_writedata                                              //                                                           .writedata
	);

	wire          hps_master_translator_avalon_universal_master_0_waitrequest;   // hps_master_agent:av_waitrequest -> hps_master_translator:uav_waitrequest
	wire   [31:0] hps_master_translator_avalon_universal_master_0_readdata;      // hps_master_agent:av_readdata -> hps_master_translator:uav_readdata
	wire          hps_master_translator_avalon_universal_master_0_debugaccess;   // hps_master_translator:uav_debugaccess -> hps_master_agent:av_debugaccess
	wire   [31:0] hps_master_translator_avalon_universal_master_0_address;       // hps_master_translator:uav_address -> hps_master_agent:av_address
	wire          hps_master_translator_avalon_universal_master_0_read;          // hps_master_translator:uav_read -> hps_master_agent:av_read
	wire    [3:0] hps_master_translator_avalon_universal_master_0_byteenable;    // hps_master_translator:uav_byteenable -> hps_master_agent:av_byteenable
	wire          hps_master_translator_avalon_universal_master_0_readdatavalid; // hps_master_agent:av_readdatavalid -> hps_master_translator:uav_readdatavalid
	wire          hps_master_translator_avalon_universal_master_0_lock;          // hps_master_translator:uav_lock -> hps_master_agent:av_lock
	wire          hps_master_translator_avalon_universal_master_0_write;         // hps_master_translator:uav_write -> hps_master_agent:av_write
	wire   [31:0] hps_master_translator_avalon_universal_master_0_writedata;     // hps_master_translator:uav_writedata -> hps_master_agent:av_writedata
	wire    [2:0] hps_master_translator_avalon_universal_master_0_burstcount;    // hps_master_translator:uav_burstcount -> hps_master_agent:av_burstcount
	wire          hps_master_agent_cp_valid;                                     // hps_master_agent:cp_valid -> router:sink_valid
	wire  [119:0] hps_master_agent_cp_data;                                      // hps_master_agent:cp_data -> router:sink_data
	wire          hps_master_agent_cp_ready;                                     // router:sink_ready -> hps_master_agent:cp_ready
	wire          hps_master_agent_cp_startofpacket;                             // hps_master_agent:cp_startofpacket -> router:sink_startofpacket
	wire          hps_master_agent_cp_endofpacket;                               // hps_master_agent:cp_endofpacket -> router:sink_endofpacket
	...
	wire          router_src_valid;                                              // router:src_valid -> hps_master_limiter:cmd_sink_valid
	wire  [119:0] router_src_data;                                               // router:src_data -> hps_master_limiter:cmd_sink_data
	wire          router_src_ready;                                              // hps_master_limiter:cmd_sink_ready -> router:src_ready
	wire    [1:0] router_src_channel;                                            // router:src_channel -> hps_master_limiter:cmd_sink_channel
	wire          router_src_startofpacket;                                      // router:src_startofpacket -> hps_master_limiter:cmd_sink_startofpacket
	wire          router_src_endofpacket;                                        // router:src_endofpacket -> hps_master_limiter:cmd_sink_endofpacket
	wire  [119:0] hps_master_limiter_cmd_src_data;                               // hps_master_limiter:cmd_src_data -> cmd_demux:sink_data
	wire          hps_master_limiter_cmd_src_ready;                              // cmd_demux:sink_ready -> hps_master_limiter:cmd_src_ready
	wire    [1:0] hps_master_limiter_cmd_src_channel;                            // hps_master_limiter:cmd_src_channel -> cmd_demux:sink_channel
	wire          hps_master_limiter_cmd_src_startofpacket;                      // hps_master_limiter:cmd_src_startofpacket -> cmd_demux:sink_startofpacket
	wire          hps_master_limiter_cmd_src_endofpacket;                        // hps_master_limiter:cmd_src_endofpacket -> cmd_demux:sink_endofpacket
	wire          rsp_mux_src_valid;                                             // rsp_mux:src_valid -> hps_master_limiter:rsp_sink_valid
	wire  [119:0] rsp_mux_src_data;                                              // rsp_mux:src_data -> hps_master_limiter:rsp_sink_data
	wire          rsp_mux_src_ready;                                             // hps_master_limiter:rsp_sink_ready -> rsp_mux:src_ready
	wire    [1:0] rsp_mux_src_channel;                                           // rsp_mux:src_channel -> hps_master_limiter:rsp_sink_channel
	wire          rsp_mux_src_startofpacket;                                     // rsp_mux:src_startofpacket -> hps_master_limiter:rsp_sink_startofpacket
	wire          rsp_mux_src_endofpacket;                                       // rsp_mux:src_endofpacket -> hps_master_limiter:rsp_sink_endofpacket
	wire          hps_master_limiter_rsp_src_valid;                              // hps_master_limiter:rsp_src_valid -> hps_master_agent:rp_valid
	wire  [119:0] hps_master_limiter_rsp_src_data;                               // hps_master_limiter:rsp_src_data -> hps_master_agent:rp_data
	wire          hps_master_limiter_rsp_src_ready;                              // hps_master_agent:rp_ready -> hps_master_limiter:rsp_src_ready
	wire    [1:0] hps_master_limiter_rsp_src_channel;                            // hps_master_limiter:rsp_src_channel -> hps_master_agent:rp_channel
	wire          hps_master_limiter_rsp_src_startofpacket;                      // hps_master_limiter:rsp_src_startofpacket -> hps_master_agent:rp_startofpacket
	wire          hps_master_limiter_rsp_src_endofpacket;                        // hps_master_limiter:rsp_src_endofpacket -> hps_master_agent:rp_endofpacket
	...
	wire    [1:0] hps_master_limiter_cmd_valid_data;                             // hps_master_limiter:cmd_src_valid -> cmd_demux:sink_valid
	...
	) hps_master_translator (
		.clk                    (clk_0_clk_clk),                                                 //                       clk.clk
		.reset                  (hps_master_translator_reset_reset_bridge_in_reset_reset),       //                     reset.reset
		.uav_address            (hps_master_translator_avalon_universal_master_0_address),       // avalon_universal_master_0.address
		.uav_burstcount         (hps_master_translator_avalon_universal_master_0_burstcount),    //                          .burstcount
		.uav_read               (hps_master_translator_avalon_universal_master_0_read),          //                          .read
		.uav_write              (hps_master_translator_avalon_universal_master_0_write),         //                          .write
		.uav_waitrequest        (hps_master_translator_avalon_universal_master_0_waitrequest),   //                          .waitrequest
		.uav_readdatavalid      (hps_master_translator_avalon_universal_master_0_readdatavalid), //                          .readdatavalid
		.uav_byteenable         (hps_master_translator_avalon_universal_master_0_byteenable),    //                          .byteenable
		.uav_readdata           (hps_master_translator_avalon_universal_master_0_readdata),      //                          .readdata
		.uav_writedata          (hps_master_translator_avalon_universal_master_0_writedata),     //                          .writedata
		.uav_lock               (hps_master_translator_avalon_universal_master_0_lock),          //                          .lock
		.uav_debugaccess        (hps_master_translator_avalon_universal_master_0_debugaccess),   //                          .debugaccess
		.av_address             (hps_master_address),                                            //      avalon_anti_master_0.address
		.av_waitrequest         (hps_master_waitrequest),                                        //                          .waitrequest
		.av_byteenable          (hps_master_byteenable),                                         //                          .byteenable
		.av_read                (hps_master_read),                                               //                          .read
		.av_readdata            (hps_master_readdata),                                           //                          .readdata
		.av_readdatavalid       (hps_master_readdatavalid),                                      //                          .readdatavalid
		.av_write               (hps_master_write),                                              //                          .write
		.av_writedata           (hps_master_writedata),                                          //                          .writedata
	...
	altera_merlin_master_agent #(
		...
		.clk                   (clk_0_clk_clk),                                                 //       clk.clk
		.reset                 (hps_master_translator_reset_reset_bridge_in_reset_reset),       // clk_reset.reset
		.av_address            (hps_master_translator_avalon_universal_master_0_address),       //        av.address
		.av_write              (hps_master_translator_avalon_universal_master_0_write),         //          .write
		.av_read               (hps_master_translator_avalon_universal_master_0_read),          //          .read
		.av_writedata          (hps_master_translator_avalon_universal_master_0_writedata),     //          .writedata
		.av_readdata           (hps_master_translator_avalon_universal_master_0_readdata),      //          .readdata
		.av_waitrequest        (hps_master_translator_avalon_universal_master_0_waitrequest),   //          .waitrequest
		.av_readdatavalid      (hps_master_translator_avalon_universal_master_0_readdatavalid), //          .readdatavalid
		.av_byteenable         (hps_master_translator_avalon_universal_master_0_byteenable),    //          .byteenable
		.av_burstcount         (hps_master_translator_avalon_universal_master_0_burstcount),    //          .burstcount
		.av_debugaccess        (hps_master_translator_avalon_universal_master_0_debugaccess),   //          .debugaccess
		.av_lock               (hps_master_translator_avalon_universal_master_0_lock),          //          .lock
		.cp_valid              (hps_master_agent_cp_valid),                                     //        cp.valid
		.cp_data               (hps_master_agent_cp_data),                                      //          .data
		.cp_startofpacket      (hps_master_agent_cp_startofpacket),                             //          .startofpacket
		.cp_endofpacket        (hps_master_agent_cp_endofpacket),                               //          .endofpacket
		.cp_ready              (hps_master_agent_cp_ready),                                     //          .ready
		.rp_valid              (hps_master_limiter_rsp_src_valid),                              //        rp.valid
		.rp_data               (hps_master_limiter_rsp_src_data),                               //          .data
		.rp_channel            (hps_master_limiter_rsp_src_channel),                            //          .channel
		.rp_startofpacket      (hps_master_limiter_rsp_src_startofpacket),                      //          .startofpacket
		.rp_endofpacket        (hps_master_limiter_rsp_src_endofpacket),                        //          .endofpacket
		.rp_ready              (hps_master_limiter_rsp_src_ready),                              //          .ready
		.av_response           (),                                                              // (terminated)
		.av_writeresponsevalid ()                                                               // (terminated)
	);
	...
	Assignment2_mm_interconnect_1_router router (
		.sink_ready         (hps_master_agent_cp_ready),                               //      sink.ready
		.sink_valid         (hps_master_agent_cp_valid),                               //          .valid
		.sink_data          (hps_master_agent_cp_data),                                //          .data
		.sink_startofpacket (hps_master_agent_cp_startofpacket),                       //          .startofpacket
		.sink_endofpacket   (hps_master_agent_cp_endofpacket),                         //          .endofpacket
		.clk                (clk_0_clk_clk),                                           //       clk.clk
		.reset              (hps_master_translator_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	Assignment2_mm_interconnect_1_router_001 router_001 (
	...
	Assignment2_mm_interconnect_1_router_001 router_002 (
	...
	altera_merlin_traffic_limiter #(
		...
		.cmd_src_ready          (hps_master_limiter_cmd_src_ready),                        //   cmd_src.ready
		.cmd_src_data           (hps_master_limiter_cmd_src_data),                         //          .data
		.cmd_src_channel        (hps_master_limiter_cmd_src_channel),                      //          .channel
		.cmd_src_startofpacket  (hps_master_limiter_cmd_src_startofpacket),                //          .startofpacket
		.cmd_src_endofpacket    (hps_master_limiter_cmd_src_endofpacket),                  //          .endofpacket
		...
		.rsp_src_ready          (hps_master_limiter_rsp_src_ready),                        //   rsp_src.ready
		.rsp_src_valid          (hps_master_limiter_rsp_src_valid),                        //          .valid
		.rsp_src_data           (hps_master_limiter_rsp_src_data),                         //          .data
		.rsp_src_channel        (hps_master_limiter_rsp_src_channel),                      //          .channel
		.rsp_src_startofpacket  (hps_master_limiter_rsp_src_startofpacket),                //          .startofpacket
		.rsp_src_endofpacket    (hps_master_limiter_rsp_src_endofpacket),                  //          .endofpacket
		.cmd_src_valid          (hps_master_limiter_cmd_valid_data)                        // cmd_valid.data
	);

	Assignment2_mm_interconnect_1_cmd_demux cmd_demux (
		.clk                (clk_0_clk_clk),                                           //        clk.clk
		.reset              (hps_master_translator_reset_reset_bridge_in_reset_reset), //  clk_reset.reset
		.sink_ready         (hps_master_limiter_cmd_src_ready),                        //       sink.ready
		.sink_channel       (hps_master_limiter_cmd_src_channel),                      //           .channel
		.sink_data          (hps_master_limiter_cmd_src_data),                         //           .data
		.sink_startofpacket (hps_master_limiter_cmd_src_startofpacket),                //           .startofpacket
		.sink_endofpacket   (hps_master_limiter_cmd_src_endofpacket),                  //           .endofpacket
		.sink_valid         (hps_master_limiter_cmd_valid_data),                       // sink_valid.data
	...
	Assignment2_mm_interconnect_1_cmd_mux cmd_mux (
		.clk                 (clk_0_clk_clk),                                                    //       clk.clk
		.reset               (hps_0_f2h_axi_slave_agent_reset_sink_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	Assignment2_mm_interconnect_1_cmd_mux cmd_mux_001 (
		.clk                 (clk_0_clk_clk),                                                    //       clk.clk
		.reset               (hps_0_f2h_axi_slave_agent_reset_sink_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	Assignment2_mm_interconnect_1_rsp_demux rsp_demux (
		.clk                (clk_0_clk_clk),                                                    //       clk.clk
		.reset              (hps_0_f2h_axi_slave_agent_reset_sink_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	Assignment2_mm_interconnect_1_rsp_demux rsp_demux_001 (
		.clk                (clk_0_clk_clk),                                                    //       clk.clk
		.reset              (hps_0_f2h_axi_slave_agent_reset_sink_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	Assignment2_mm_interconnect_1_rsp_mux rsp_mux (
		.clk                 (clk_0_clk_clk),                                           //       clk.clk
		.reset               (hps_master_translator_reset_reset_bridge_in_reset_reset), // clk_reset.reset

// Assignment2_mm_interconnect_0.v
...
`timescale 1 ps / 1 ps
module Assignment2_mm_interconnect_0 (
		...
		input  wire        fpga_clk_reset_reset_bridge_in_reset_reset,                       //                       fpga_clk_reset_reset_bridge_in_reset.reset
		...
		input  wire [31:0] fpga_master_address,                                              //                                                fpga_master.address
		output wire        fpga_master_waitrequest,                                          //                                                           .waitrequest
		input  wire [3:0]  fpga_master_byteenable,                                           //                                                           .byteenable
		input  wire        fpga_master_read,                                                 //                                                           .read
		output wire [31:0] fpga_master_readdata,                                             //                                                           .readdata
		output wire        fpga_master_readdatavalid,                                        //                                                           .readdatavalid
		input  wire        fpga_master_write,                                                //                                                           .write
		input  wire [31:0] fpga_master_writedata,                                            //                                                           .writedata
		output wire [2:0]  dipsw_pio_s1_address,                                             //                                               dipsw_pio_s1.address
		...
		output wire        led_pio_avalon_slave_0_read,                                      //                                                           .read
	...
	wire          fpga_master_translator_avalon_universal_master_0_waitrequest;           // fpga_master_agent:av_waitrequest -> fpga_master_translator:uav_waitrequest
	wire   [31:0] fpga_master_translator_avalon_universal_master_0_readdata;              // fpga_master_agent:av_readdata -> fpga_master_translator:uav_readdata
	wire          fpga_master_translator_avalon_universal_master_0_debugaccess;           // fpga_master_translator:uav_debugaccess -> fpga_master_agent:av_debugaccess
	wire   [31:0] fpga_master_translator_avalon_universal_master_0_address;               // fpga_master_translator:uav_address -> fpga_master_agent:av_address
	wire          fpga_master_translator_avalon_universal_master_0_read;                  // fpga_master_translator:uav_read -> fpga_master_agent:av_read
	wire    [3:0] fpga_master_translator_avalon_universal_master_0_byteenable;            // fpga_master_translator:uav_byteenable -> fpga_master_agent:av_byteenable
	wire          fpga_master_translator_avalon_universal_master_0_readdatavalid;         // fpga_master_agent:av_readdatavalid -> fpga_master_translator:uav_readdatavalid
	wire          fpga_master_translator_avalon_universal_master_0_lock;                  // fpga_master_translator:uav_lock -> fpga_master_agent:av_lock
	wire          fpga_master_translator_avalon_universal_master_0_write;                 // fpga_master_translator:uav_write -> fpga_master_agent:av_write
	wire   [31:0] fpga_master_translator_avalon_universal_master_0_writedata;             // fpga_master_translator:uav_writedata -> fpga_master_agent:av_writedata
	wire    [2:0] fpga_master_translator_avalon_universal_master_0_burstcount;            // fpga_master_translator:uav_burstcount -> fpga_master_agent:av_burstcount
	...
	wire   [31:0] led_pio_avalon_slave_0_agent_m0_readdata;                               // led_pio_avalon_slave_0_translator:uav_readdata -> led_pio_avalon_slave_0_agent:m0_readdata
	wire          led_pio_avalon_slave_0_agent_m0_waitrequest;                            // led_pio_avalon_slave_0_translator:uav_waitrequest -> led_pio_avalon_slave_0_agent:m0_waitrequest
	wire          led_pio_avalon_slave_0_agent_m0_debugaccess;                            // led_pio_avalon_slave_0_agent:m0_debugaccess -> led_pio_avalon_slave_0_translator:uav_debugaccess
	wire   [31:0] led_pio_avalon_slave_0_agent_m0_address;                                // led_pio_avalon_slave_0_agent:m0_address -> led_pio_avalon_slave_0_translator:uav_address
	wire    [3:0] led_pio_avalon_slave_0_agent_m0_byteenable;                             // led_pio_avalon_slave_0_agent:m0_byteenable -> led_pio_avalon_slave_0_translator:uav_byteenable
	wire          led_pio_avalon_slave_0_agent_m0_read;                                   // led_pio_avalon_slave_0_agent:m0_read -> led_pio_avalon_slave_0_translator:uav_read
	wire          led_pio_avalon_slave_0_agent_m0_readdatavalid;                          // led_pio_avalon_slave_0_translator:uav_readdatavalid -> led_pio_avalon_slave_0_agent:m0_readdatavalid
	wire          led_pio_avalon_slave_0_agent_m0_lock;                                   // led_pio_avalon_slave_0_agent:m0_lock -> led_pio_avalon_slave_0_translator:uav_lock
	wire   [31:0] led_pio_avalon_slave_0_agent_m0_writedata;                              // led_pio_avalon_slave_0_agent:m0_writedata -> led_pio_avalon_slave_0_translator:uav_writedata
	wire          led_pio_avalon_slave_0_agent_m0_write;                                  // led_pio_avalon_slave_0_agent:m0_write -> led_pio_avalon_slave_0_translator:uav_write
	wire    [2:0] led_pio_avalon_slave_0_agent_m0_burstcount;                             // led_pio_avalon_slave_0_agent:m0_burstcount -> led_pio_avalon_slave_0_translator:uav_burstcount
	wire          led_pio_avalon_slave_0_agent_rf_source_valid;                           // led_pio_avalon_slave_0_agent:rf_source_valid -> led_pio_avalon_slave_0_agent_rsp_fifo:in_valid
	wire  [127:0] led_pio_avalon_slave_0_agent_rf_source_data;                            // led_pio_avalon_slave_0_agent:rf_source_data -> led_pio_avalon_slave_0_agent_rsp_fifo:in_data
	wire          led_pio_avalon_slave_0_agent_rf_source_ready;                           // led_pio_avalon_slave_0_agent_rsp_fifo:in_ready -> led_pio_avalon_slave_0_agent:rf_source_ready
	wire          led_pio_avalon_slave_0_agent_rf_source_startofpacket;                   // led_pio_avalon_slave_0_agent:rf_source_startofpacket -> led_pio_avalon_slave_0_agent_rsp_fifo:in_startofpacket
	wire          led_pio_avalon_slave_0_agent_rf_source_endofpacket;                     // led_pio_avalon_slave_0_agent:rf_source_endofpacket -> led_pio_avalon_slave_0_agent_rsp_fifo:in_endofpacket
	wire          led_pio_avalon_slave_0_agent_rsp_fifo_out_valid;                        // led_pio_avalon_slave_0_agent_rsp_fifo:out_valid -> led_pio_avalon_slave_0_agent:rf_sink_valid
	wire  [127:0] led_pio_avalon_slave_0_agent_rsp_fifo_out_data;                         // led_pio_avalon_slave_0_agent_rsp_fifo:out_data -> led_pio_avalon_slave_0_agent:rf_sink_data
	wire          led_pio_avalon_slave_0_agent_rsp_fifo_out_ready;                        // led_pio_avalon_slave_0_agent:rf_sink_ready -> led_pio_avalon_slave_0_agent_rsp_fifo:out_ready
	wire          led_pio_avalon_slave_0_agent_rsp_fifo_out_startofpacket;                // led_pio_avalon_slave_0_agent_rsp_fifo:out_startofpacket -> led_pio_avalon_slave_0_agent:rf_sink_startofpacket
	wire          led_pio_avalon_slave_0_agent_rsp_fifo_out_endofpacket;                  // led_pio_avalon_slave_0_agent_rsp_fifo:out_endofpacket -> led_pio_avalon_slave_0_agent:rf_sink_endofpacket
	wire          led_pio_avalon_slave_0_agent_rdata_fifo_src_valid;                      // led_pio_avalon_slave_0_agent:rdata_fifo_src_valid -> led_pio_avalon_slave_0_agent_rdata_fifo:in_valid
	wire   [33:0] led_pio_avalon_slave_0_agent_rdata_fifo_src_data;                       // led_pio_avalon_slave_0_agent:rdata_fifo_src_data -> led_pio_avalon_slave_0_agent_rdata_fifo:in_data
	wire          led_pio_avalon_slave_0_agent_rdata_fifo_src_ready;                      // led_pio_avalon_slave_0_agent_rdata_fifo:in_ready -> led_pio_avalon_slave_0_agent:rdata_fifo_src_ready
	...
	wire          fpga_master_agent_cp_valid;                                             // fpga_master_agent:cp_valid -> router_002:sink_valid
	wire  [126:0] fpga_master_agent_cp_data;                                              // fpga_master_agent:cp_data -> router_002:sink_data
	wire          fpga_master_agent_cp_ready;                                             // router_002:sink_ready -> fpga_master_agent:cp_ready
	wire          fpga_master_agent_cp_startofpacket;                                     // fpga_master_agent:cp_startofpacket -> router_002:sink_startofpacket
	wire          fpga_master_agent_cp_endofpacket;                                       // fpga_master_agent:cp_endofpacket -> router_002:sink_endofpacket
	...
	wire          led_pio_avalon_slave_0_agent_rp_valid;                                  // led_pio_avalon_slave_0_agent:rp_valid -> router_007:sink_valid
	wire  [126:0] led_pio_avalon_slave_0_agent_rp_data;                                   // led_pio_avalon_slave_0_agent:rp_data -> router_007:sink_data
	wire          led_pio_avalon_slave_0_agent_rp_ready;                                  // router_007:sink_ready -> led_pio_avalon_slave_0_agent:rp_ready
	wire          led_pio_avalon_slave_0_agent_rp_startofpacket;                          // led_pio_avalon_slave_0_agent:rp_startofpacket -> router_007:sink_startofpacket
	wire          led_pio_avalon_slave_0_agent_rp_endofpacket;                            // led_pio_avalon_slave_0_agent:rp_endofpacket -> router_007:sink_endofpacket
	...
	wire          router_002_src_valid;                                                   // router_002:src_valid -> fpga_master_limiter:cmd_sink_valid
	wire  [126:0] router_002_src_data;                                                    // router_002:src_data -> fpga_master_limiter:cmd_sink_data
	wire          router_002_src_ready;                                                   // fpga_master_limiter:cmd_sink_ready -> router_002:src_ready
	wire    [4:0] router_002_src_channel;                                                 // router_002:src_channel -> fpga_master_limiter:cmd_sink_channel
	wire          router_002_src_startofpacket;                                           // router_002:src_startofpacket -> fpga_master_limiter:cmd_sink_startofpacket
	wire          router_002_src_endofpacket;                                             // router_002:src_endofpacket -> fpga_master_limiter:cmd_sink_endofpacket
	wire  [126:0] fpga_master_limiter_cmd_src_data;                                       // fpga_master_limiter:cmd_src_data -> cmd_demux_002:sink_data
	wire          fpga_master_limiter_cmd_src_ready;                                      // cmd_demux_002:sink_ready -> fpga_master_limiter:cmd_src_ready
	wire    [4:0] fpga_master_limiter_cmd_src_channel;                                    // fpga_master_limiter:cmd_src_channel -> cmd_demux_002:sink_channel
	wire          fpga_master_limiter_cmd_src_startofpacket;                              // fpga_master_limiter:cmd_src_startofpacket -> cmd_demux_002:sink_startofpacket
	wire          fpga_master_limiter_cmd_src_endofpacket;                                // fpga_master_limiter:cmd_src_endofpacket -> cmd_demux_002:sink_endofpacket
	wire          rsp_mux_002_src_valid;                                                  // rsp_mux_002:src_valid -> fpga_master_limiter:rsp_sink_valid
	wire  [126:0] rsp_mux_002_src_data;                                                   // rsp_mux_002:src_data -> fpga_master_limiter:rsp_sink_data
	wire          rsp_mux_002_src_ready;                                                  // fpga_master_limiter:rsp_sink_ready -> rsp_mux_002:src_ready
	wire    [4:0] rsp_mux_002_src_channel;                                                // rsp_mux_002:src_channel -> fpga_master_limiter:rsp_sink_channel
	wire          rsp_mux_002_src_startofpacket;                                          // rsp_mux_002:src_startofpacket -> fpga_master_limiter:rsp_sink_startofpacket
	wire          rsp_mux_002_src_endofpacket;                                            // rsp_mux_002:src_endofpacket -> fpga_master_limiter:rsp_sink_endofpacket
	wire          fpga_master_limiter_rsp_src_valid;                                      // fpga_master_limiter:rsp_src_valid -> fpga_master_agent:rp_valid
	wire  [126:0] fpga_master_limiter_rsp_src_data;                                       // fpga_master_limiter:rsp_src_data -> fpga_master_agent:rp_data
	wire          fpga_master_limiter_rsp_src_ready;                                      // fpga_master_agent:rp_ready -> fpga_master_limiter:rsp_src_ready
	wire    [4:0] fpga_master_limiter_rsp_src_channel;                                    // fpga_master_limiter:rsp_src_channel -> fpga_master_agent:rp_channel
	wire          fpga_master_limiter_rsp_src_startofpacket;                              // fpga_master_limiter:rsp_src_startofpacket -> fpga_master_agent:rp_startofpacket
	wire          fpga_master_limiter_rsp_src_endofpacket;                                // fpga_master_limiter:rsp_src_endofpacket -> fpga_master_agent:rp_endofpacket
	...
	wire  [126:0] cmd_mux_001_src_data;                                                   // cmd_mux_001:src_data -> jtag_uart_0_avalon_jtag_slave_burst_adapter:sink0_data
	wire          cmd_mux_001_src_ready;                                                  // jtag_uart_0_avalon_jtag_slave_burst_adapter:sink0_ready -> cmd_mux_001:src_ready
	wire    [4:0] cmd_mux_001_src_channel;                                                // cmd_mux_001:src_channel -> jtag_uart_0_avalon_jtag_slave_burst_adapter:sink0_channel
	...
	wire          cmd_mux_002_src_valid;                                                  // cmd_mux_002:src_valid -> led_pio_avalon_slave_0_burst_adapter:sink0_valid
	wire  [126:0] cmd_mux_002_src_data;                                                   // cmd_mux_002:src_data -> led_pio_avalon_slave_0_burst_adapter:sink0_data
	wire          cmd_mux_002_src_ready;                                                  // led_pio_avalon_slave_0_burst_adapter:sink0_ready -> cmd_mux_002:src_ready
	wire    [4:0] cmd_mux_002_src_channel;                                                // cmd_mux_002:src_channel -> led_pio_avalon_slave_0_burst_adapter:sink0_channel
	wire          cmd_mux_002_src_startofpacket;                                          // cmd_mux_002:src_startofpacket -> led_pio_avalon_slave_0_burst_adapter:sink0_startofpacket
	wire          cmd_mux_002_src_endofpacket;                                            // cmd_mux_002:src_endofpacket -> led_pio_avalon_slave_0_burst_adapter:sink0_endofpacket
	wire          led_pio_avalon_slave_0_burst_adapter_source0_valid;                     // led_pio_avalon_slave_0_burst_adapter:source0_valid -> led_pio_avalon_slave_0_agent:cp_valid
	wire  [126:0] led_pio_avalon_slave_0_burst_adapter_source0_data;                      // led_pio_avalon_slave_0_burst_adapter:source0_data -> led_pio_avalon_slave_0_agent:cp_data
	wire          led_pio_avalon_slave_0_burst_adapter_source0_ready;                     // led_pio_avalon_slave_0_agent:cp_ready -> led_pio_avalon_slave_0_burst_adapter:source0_ready
	wire    [4:0] led_pio_avalon_slave_0_burst_adapter_source0_channel;                   // led_pio_avalon_slave_0_burst_adapter:source0_channel -> led_pio_avalon_slave_0_agent:cp_channel
	wire          led_pio_avalon_slave_0_burst_adapter_source0_startofpacket;             // led_pio_avalon_slave_0_burst_adapter:source0_startofpacket -> led_pio_avalon_slave_0_agent:cp_startofpacket
	wire          led_pio_avalon_slave_0_burst_adapter_source0_endofpacket;               // led_pio_avalon_slave_0_burst_adapter:source0_endofpacket -> led_pio_avalon_slave_0_agent:cp_endofpacket
	wire          cmd_mux_003_src_valid;                                                  // cmd_mux_003:src_valid -> dipsw_pio_s1_burst_adapter:sink0_valid
	wire  [126:0] cmd_mux_003_src_data;                                                   // cmd_mux_003:src_data -> dipsw_pio_s1_burst_adapter:sink0_data
	wire          cmd_mux_003_src_ready;                                                  // dipsw_pio_s1_burst_adapter:sink0_ready -> cmd_mux_003:src_ready
	wire    [4:0] cmd_mux_003_src_channel;                                                // cmd_mux_003:src_channel -> dipsw_pio_s1_burst_adapter:sink0_channel
	wire          cmd_mux_003_src_startofpacket;                                          // cmd_mux_003:src_startofpacket -> dipsw_pio_s1_burst_adapter:sink0_startofpacket
	wire          cmd_mux_003_src_endofpacket;                                            // cmd_mux_003:src_endofpacket -> dipsw_pio_s1_burst_adapter:sink0_endofpacket
	...
	wire  [126:0] cmd_demux_003_src2_data;                                                // cmd_demux_003:src2_data -> cmd_mux_003:sink1_data
	...
	wire  [126:0] cmd_demux_004_src2_data;                                                // cmd_demux_004:src2_data -> cmd_mux_003:sink2_data
	...
	wire  [126:0] rsp_demux_003_src1_data;                                                // rsp_demux_003:src1_data -> rsp_mux_003:sink2_data
	...
	wire  [126:0] rsp_demux_003_src2_data;                                                // rsp_demux_003:src2_data -> rsp_mux_004:sink2_data
	...
	wire          cmd_demux_002_src0_valid;                                               // cmd_demux_002:src0_valid -> fpga_master_to_onchip_memory2_0_s1_cmd_width_adapter:in_valid
	wire  [126:0] cmd_demux_002_src0_data;                                                // cmd_demux_002:src0_data -> fpga_master_to_onchip_memory2_0_s1_cmd_width_adapter:in_data
	wire          cmd_demux_002_src0_ready;                                               // fpga_master_to_onchip_memory2_0_s1_cmd_width_adapter:in_ready -> cmd_demux_002:src0_ready
	wire    [4:0] cmd_demux_002_src0_channel;                                             // cmd_demux_002:src0_channel -> fpga_master_to_onchip_memory2_0_s1_cmd_width_adapter:in_channel
	wire          cmd_demux_002_src0_startofpacket;                                       // cmd_demux_002:src0_startofpacket -> fpga_master_to_onchip_memory2_0_s1_cmd_width_adapter:in_startofpacket
	wire          cmd_demux_002_src0_endofpacket;                                         // cmd_demux_002:src0_endofpacket -> fpga_master_to_onchip_memory2_0_s1_cmd_width_adapter:in_endofpacket
	wire          fpga_master_to_onchip_memory2_0_s1_cmd_width_adapter_src_valid;         // fpga_master_to_onchip_memory2_0_s1_cmd_width_adapter:out_valid -> cmd_mux:sink2_valid
	wire  [162:0] fpga_master_to_onchip_memory2_0_s1_cmd_width_adapter_src_data;          // fpga_master_to_onchip_memory2_0_s1_cmd_width_adapter:out_data -> cmd_mux:sink2_data
	wire          fpga_master_to_onchip_memory2_0_s1_cmd_width_adapter_src_ready;         // cmd_mux:sink2_ready -> fpga_master_to_onchip_memory2_0_s1_cmd_width_adapter:out_ready
	wire    [4:0] fpga_master_to_onchip_memory2_0_s1_cmd_width_adapter_src_channel;       // fpga_master_to_onchip_memory2_0_s1_cmd_width_adapter:out_channel -> cmd_mux:sink2_channel
	wire          fpga_master_to_onchip_memory2_0_s1_cmd_width_adapter_src_startofpacket; // fpga_master_to_onchip_memory2_0_s1_cmd_width_adapter:out_startofpacket -> cmd_mux:sink2_startofpacket
	wire          fpga_master_to_onchip_memory2_0_s1_cmd_width_adapter_src_endofpacket;   // fpga_master_to_onchip_memory2_0_s1_cmd_width_adapter:out_endofpacket -> cmd_mux:sink2_endofpacket
	wire          rsp_demux_src2_valid;                                                   // rsp_demux:src2_valid -> onchip_memory2_0_s1_to_fpga_master_rsp_width_adapter:in_valid
	wire  [162:0] rsp_demux_src2_data;                                                    // rsp_demux:src2_data -> onchip_memory2_0_s1_to_fpga_master_rsp_width_adapter:in_data
	wire          rsp_demux_src2_ready;                                                   // onchip_memory2_0_s1_to_fpga_master_rsp_width_adapter:in_ready -> rsp_demux:src2_ready
	wire    [4:0] rsp_demux_src2_channel;                                                 // rsp_demux:src2_channel -> onchip_memory2_0_s1_to_fpga_master_rsp_width_adapter:in_channel
	wire          rsp_demux_src2_startofpacket;                                           // rsp_demux:src2_startofpacket -> onchip_memory2_0_s1_to_fpga_master_rsp_width_adapter:in_startofpacket
	wire          rsp_demux_src2_endofpacket;                                             // rsp_demux:src2_endofpacket -> onchip_memory2_0_s1_to_fpga_master_rsp_width_adapter:in_endofpacket
	wire          onchip_memory2_0_s1_to_fpga_master_rsp_width_adapter_src_valid;         // onchip_memory2_0_s1_to_fpga_master_rsp_width_adapter:out_valid -> rsp_mux_002:sink0_valid
	wire  [126:0] onchip_memory2_0_s1_to_fpga_master_rsp_width_adapter_src_data;          // onchip_memory2_0_s1_to_fpga_master_rsp_width_adapter:out_data -> rsp_mux_002:sink0_data
	wire          onchip_memory2_0_s1_to_fpga_master_rsp_width_adapter_src_ready;         // rsp_mux_002:sink0_ready -> onchip_memory2_0_s1_to_fpga_master_rsp_width_adapter:out_ready
	wire    [4:0] onchip_memory2_0_s1_to_fpga_master_rsp_width_adapter_src_channel;       // onchip_memory2_0_s1_to_fpga_master_rsp_width_adapter:out_channel -> rsp_mux_002:sink0_channel
	wire          onchip_memory2_0_s1_to_fpga_master_rsp_width_adapter_src_startofpacket; // onchip_memory2_0_s1_to_fpga_master_rsp_width_adapter:out_startofpacket -> rsp_mux_002:sink0_startofpacket
	wire          onchip_memory2_0_s1_to_fpga_master_rsp_width_adapter_src_endofpacket;   // onchip_memory2_0_s1_to_fpga_master_rsp_width_adapter:out_endofpacket -> rsp_mux_002:sink0_endofpacket
	wire    [4:0] fpga_master_limiter_cmd_valid_data;                                     // fpga_master_limiter:cmd_src_valid -> cmd_demux_002:sink_valid
	...
	wire          led_pio_avalon_slave_0_agent_rdata_fifo_out_valid;                      // led_pio_avalon_slave_0_agent_rdata_fifo:out_valid -> avalon_st_adapter_002:in_0_valid
	wire   [33:0] led_pio_avalon_slave_0_agent_rdata_fifo_out_data;                       // led_pio_avalon_slave_0_agent_rdata_fifo:out_data -> avalon_st_adapter_002:in_0_data
	wire          led_pio_avalon_slave_0_agent_rdata_fifo_out_ready;                      // avalon_st_adapter_002:in_0_ready -> led_pio_avalon_slave_0_agent_rdata_fifo:out_ready
	wire          avalon_st_adapter_002_out_0_valid;                                      // avalon_st_adapter_002:out_0_valid -> led_pio_avalon_slave_0_agent:rdata_fifo_sink_valid
	wire   [33:0] avalon_st_adapter_002_out_0_data;                                       // avalon_st_adapter_002:out_0_data -> led_pio_avalon_slave_0_agent:rdata_fifo_sink_data
	wire          avalon_st_adapter_002_out_0_ready;                                      // led_pio_avalon_slave_0_agent:rdata_fifo_sink_ready -> avalon_st_adapter_002:out_0_ready
	wire    [0:0] avalon_st_adapter_002_out_0_error;                                      // avalon_st_adapter_002:out_0_error -> led_pio_avalon_slave_0_agent:rdata_fifo_sink_error
	...
	) fpga_master_translator (
		.clk                    (clk_0_clk_clk),                                                  //                       clk.clk
		.reset                  (onchip_memory2_0_reset1_reset_bridge_in_reset_reset),            //                     reset.reset
		.uav_address            (fpga_master_translator_avalon_universal_master_0_address),       // avalon_universal_master_0.address
		.uav_burstcount         (fpga_master_translator_avalon_universal_master_0_burstcount),    //                          .burstcount
		.uav_read               (fpga_master_translator_avalon_universal_master_0_read),          //                          .read
		.uav_write              (fpga_master_translator_avalon_universal_master_0_write),         //                          .write
		.uav_waitrequest        (fpga_master_translator_avalon_universal_master_0_waitrequest),   //                          .waitrequest
		.uav_readdatavalid      (fpga_master_translator_avalon_universal_master_0_readdatavalid), //                          .readdatavalid
		.uav_byteenable         (fpga_master_translator_avalon_universal_master_0_byteenable),    //                          .byteenable
		.uav_readdata           (fpga_master_translator_avalon_universal_master_0_readdata),      //                          .readdata
		.uav_writedata          (fpga_master_translator_avalon_universal_master_0_writedata),     //                          .writedata
		.uav_lock               (fpga_master_translator_avalon_universal_master_0_lock),          //                          .lock
		.uav_debugaccess        (fpga_master_translator_avalon_universal_master_0_debugaccess),   //                          .debugaccess
		.av_address             (fpga_master_address),                                            //      avalon_anti_master_0.address
		.av_waitrequest         (fpga_master_waitrequest),                                        //                          .waitrequest
		.av_byteenable          (fpga_master_byteenable),                                         //                          .byteenable
		.av_read                (fpga_master_read),                                               //                          .read
		.av_readdata            (fpga_master_readdata),                                           //                          .readdata
		.av_readdatavalid       (fpga_master_readdatavalid),                                      //                          .readdatavalid
		.av_write               (fpga_master_write),                                              //                          .write
		.av_writedata           (fpga_master_writedata),                                          //                          .writedata
	...
	altera_merlin_slave_translator #(
		...
		.clk                    (clk_0_clk_clk),                                       //                      clk.clk
		.reset                  (onchip_memory2_0_reset1_reset_bridge_in_reset_reset), //                    reset.reset
		.uav_address            (led_pio_avalon_slave_0_agent_m0_address),             // avalon_universal_slave_0.address
		.uav_burstcount         (led_pio_avalon_slave_0_agent_m0_burstcount),          //                         .burstcount
		.uav_read               (led_pio_avalon_slave_0_agent_m0_read),                //                         .read
		.uav_write              (led_pio_avalon_slave_0_agent_m0_write),               //                         .write
		.uav_waitrequest        (led_pio_avalon_slave_0_agent_m0_waitrequest),         //                         .waitrequest
		.uav_readdatavalid      (led_pio_avalon_slave_0_agent_m0_readdatavalid),       //                         .readdatavalid
		.uav_byteenable         (led_pio_avalon_slave_0_agent_m0_byteenable),          //                         .byteenable
		.uav_readdata           (led_pio_avalon_slave_0_agent_m0_readdata),            //                         .readdata
		.uav_writedata          (led_pio_avalon_slave_0_agent_m0_writedata),           //                         .writedata
		.uav_lock               (led_pio_avalon_slave_0_agent_m0_lock),                //                         .lock
		.uav_debugaccess        (led_pio_avalon_slave_0_agent_m0_debugaccess),         //                         .debugaccess
		.av_address             (led_pio_avalon_slave_0_address),                      //      avalon_anti_slave_0.address
		.av_write               (led_pio_avalon_slave_0_write),                        //                         .write
		.av_read                (led_pio_avalon_slave_0_read),                         //                         .read
	...
	altera_merlin_master_agent #(
		...
		.av_address            (fpga_master_translator_avalon_universal_master_0_address),       //        av.address
		.av_write              (fpga_master_translator_avalon_universal_master_0_write),         //          .write
		.av_read               (fpga_master_translator_avalon_universal_master_0_read),          //          .read
		.av_writedata          (fpga_master_translator_avalon_universal_master_0_writedata),     //          .writedata
		.av_readdata           (fpga_master_translator_avalon_universal_master_0_readdata),      //          .readdata
		.av_waitrequest        (fpga_master_translator_avalon_universal_master_0_waitrequest),   //          .waitrequest
		.av_readdatavalid      (fpga_master_translator_avalon_universal_master_0_readdatavalid), //          .readdatavalid
		.av_byteenable         (fpga_master_translator_avalon_universal_master_0_byteenable),    //          .byteenable
		.av_burstcount         (fpga_master_translator_avalon_universal_master_0_burstcount),    //          .burstcount
		.av_debugaccess        (fpga_master_translator_avalon_universal_master_0_debugaccess),   //          .debugaccess
		.av_lock               (fpga_master_translator_avalon_universal_master_0_lock),          //          .lock
		.cp_valid              (fpga_master_agent_cp_valid),                                     //        cp.valid
		.cp_data               (fpga_master_agent_cp_data),                                      //          .data
		.cp_startofpacket      (fpga_master_agent_cp_startofpacket),                             //          .startofpacket
		.cp_endofpacket        (fpga_master_agent_cp_endofpacket),                               //          .endofpacket
		.cp_ready              (fpga_master_agent_cp_ready),                                     //          .ready
		.rp_valid              (fpga_master_limiter_rsp_src_valid),                              //        rp.valid
		.rp_data               (fpga_master_limiter_rsp_src_data),                               //          .data
		.rp_channel            (fpga_master_limiter_rsp_src_channel),                            //          .channel
		.rp_startofpacket      (fpga_master_limiter_rsp_src_startofpacket),                      //          .startofpacket
		.rp_endofpacket        (fpga_master_limiter_rsp_src_endofpacket),                        //          .endofpacket
		.rp_ready              (fpga_master_limiter_rsp_src_ready),                              //          .ready
		.av_response           (),                                                               // (terminated)
		.av_writeresponsevalid ()                                                                // (terminated)
	);
	...
	altera_merlin_slave_agent #(
		...
		.USE_WRITERESPONSE         (0),
		.ECC_ENABLE                (0)
	) led_pio_avalon_slave_0_agent (
		.clk                     (clk_0_clk_clk),                                              //             clk.clk
		.reset                   (onchip_memory2_0_reset1_reset_bridge_in_reset_reset),        //       clk_reset.reset
		.m0_address              (led_pio_avalon_slave_0_agent_m0_address),                    //              m0.address
		.m0_burstcount           (led_pio_avalon_slave_0_agent_m0_burstcount),                 //                .burstcount
		.m0_byteenable           (led_pio_avalon_slave_0_agent_m0_byteenable),                 //                .byteenable
		.m0_debugaccess          (led_pio_avalon_slave_0_agent_m0_debugaccess),                //                .debugaccess
		.m0_lock                 (led_pio_avalon_slave_0_agent_m0_lock),                       //                .lock
		.m0_readdata             (led_pio_avalon_slave_0_agent_m0_readdata),                   //                .readdata
		.m0_readdatavalid        (led_pio_avalon_slave_0_agent_m0_readdatavalid),              //                .readdatavalid
		.m0_read                 (led_pio_avalon_slave_0_agent_m0_read),                       //                .read
		.m0_waitrequest          (led_pio_avalon_slave_0_agent_m0_waitrequest),                //                .waitrequest
		.m0_writedata            (led_pio_avalon_slave_0_agent_m0_writedata),                  //                .writedata
		.m0_write                (led_pio_avalon_slave_0_agent_m0_write),                      //                .write
		.rp_endofpacket          (led_pio_avalon_slave_0_agent_rp_endofpacket),                //              rp.endofpacket
		.rp_ready                (led_pio_avalon_slave_0_agent_rp_ready),                      //                .ready
		.rp_valid                (led_pio_avalon_slave_0_agent_rp_valid),                      //                .valid
		.rp_data                 (led_pio_avalon_slave_0_agent_rp_data),                       //                .data
		.rp_startofpacket        (led_pio_avalon_slave_0_agent_rp_startofpacket),              //                .startofpacket
		.cp_ready                (led_pio_avalon_slave_0_burst_adapter_source0_ready),         //              cp.ready
		.cp_valid                (led_pio_avalon_slave_0_burst_adapter_source0_valid),         //                .valid
		.cp_data                 (led_pio_avalon_slave_0_burst_adapter_source0_data),          //                .data
		.cp_startofpacket        (led_pio_avalon_slave_0_burst_adapter_source0_startofpacket), //                .startofpacket
		.cp_endofpacket          (led_pio_avalon_slave_0_burst_adapter_source0_endofpacket),   //                .endofpacket
		.cp_channel              (led_pio_avalon_slave_0_burst_adapter_source0_channel),       //                .channel
		.rf_sink_ready           (led_pio_avalon_slave_0_agent_rsp_fifo_out_ready),            //         rf_sink.ready
		.rf_sink_valid           (led_pio_avalon_slave_0_agent_rsp_fifo_out_valid),            //                .valid
		.rf_sink_startofpacket   (led_pio_avalon_slave_0_agent_rsp_fifo_out_startofpacket),    //                .startofpacket
		.rf_sink_endofpacket     (led_pio_avalon_slave_0_agent_rsp_fifo_out_endofpacket),      //                .endofpacket
		.rf_sink_data            (led_pio_avalon_slave_0_agent_rsp_fifo_out_data),             //                .data
		.rf_source_ready         (led_pio_avalon_slave_0_agent_rf_source_ready),               //       rf_source.ready
		.rf_source_valid         (led_pio_avalon_slave_0_agent_rf_source_valid),               //                .valid
		.rf_source_startofpacket (led_pio_avalon_slave_0_agent_rf_source_startofpacket),       //                .startofpacket
		.rf_source_endofpacket   (led_pio_avalon_slave_0_agent_rf_source_endofpacket),         //                .endofpacket
		.rf_source_data          (led_pio_avalon_slave_0_agent_rf_source_data),                //                .data
		.rdata_fifo_sink_ready   (avalon_st_adapter_002_out_0_ready),                          // rdata_fifo_sink.ready
		.rdata_fifo_sink_valid   (avalon_st_adapter_002_out_0_valid),                          //                .valid
		.rdata_fifo_sink_data    (avalon_st_adapter_002_out_0_data),                           //                .data
		.rdata_fifo_sink_error   (avalon_st_adapter_002_out_0_error),                          //                .error
		.rdata_fifo_src_ready    (led_pio_avalon_slave_0_agent_rdata_fifo_src_ready),          //  rdata_fifo_src.ready
		.rdata_fifo_src_valid    (led_pio_avalon_slave_0_agent_rdata_fifo_src_valid),          //                .valid
		.rdata_fifo_src_data     (led_pio_avalon_slave_0_agent_rdata_fifo_src_data),           //                .data
		.m0_response             (2'b00),                                                      //     (terminated)
		.m0_writeresponsevalid   (1'b0)                                                        //     (terminated)
	);
	...
	altera_avalon_sc_fifo #(
		...
		.USE_ALMOST_FULL_IF  (0),
		.USE_ALMOST_EMPTY_IF (0)
	) led_pio_avalon_slave_0_agent_rsp_fifo (
		.clk               (clk_0_clk_clk),                                           //       clk.clk
		.reset             (onchip_memory2_0_reset1_reset_bridge_in_reset_reset),     // clk_reset.reset
		.in_data           (led_pio_avalon_slave_0_agent_rf_source_data),             //        in.data
		.in_valid          (led_pio_avalon_slave_0_agent_rf_source_valid),            //          .valid
		.in_ready          (led_pio_avalon_slave_0_agent_rf_source_ready),            //          .ready
		.in_startofpacket  (led_pio_avalon_slave_0_agent_rf_source_startofpacket),    //          .startofpacket
		.in_endofpacket    (led_pio_avalon_slave_0_agent_rf_source_endofpacket),      //          .endofpacket
		.out_data          (led_pio_avalon_slave_0_agent_rsp_fifo_out_data),          //       out.data
		.out_valid         (led_pio_avalon_slave_0_agent_rsp_fifo_out_valid),         //          .valid
		.out_ready         (led_pio_avalon_slave_0_agent_rsp_fifo_out_ready),         //          .ready
		.out_startofpacket (led_pio_avalon_slave_0_agent_rsp_fifo_out_startofpacket), //          .startofpacket
		.out_endofpacket   (led_pio_avalon_slave_0_agent_rsp_fifo_out_endofpacket),   //          .endofpacket
		.csr_address       (2'b00),                                                   // (terminated)
		.csr_read          (1'b0),                                                    // (terminated)
		.csr_write         (1'b0),                                                    // (terminated)
		.csr_readdata      (),                                                        // (terminated)
	...
	altera_avalon_sc_fifo #(
		...
		.USE_ALMOST_FULL_IF  (0),
		.USE_ALMOST_EMPTY_IF (0)
	) led_pio_avalon_slave_0_agent_rdata_fifo (
		.clk               (clk_0_clk_clk),                                       //       clk.clk
		.reset             (onchip_memory2_0_reset1_reset_bridge_in_reset_reset), // clk_reset.reset
		.in_data           (led_pio_avalon_slave_0_agent_rdata_fifo_src_data),    //        in.data
		.in_valid          (led_pio_avalon_slave_0_agent_rdata_fifo_src_valid),   //          .valid
		.in_ready          (led_pio_avalon_slave_0_agent_rdata_fifo_src_ready),   //          .ready
		.out_data          (led_pio_avalon_slave_0_agent_rdata_fifo_out_data),    //       out.data
		.out_valid         (led_pio_avalon_slave_0_agent_rdata_fifo_out_valid),   //          .valid
		.out_ready         (led_pio_avalon_slave_0_agent_rdata_fifo_out_ready),   //          .ready
		.csr_address       (2'b00),                                               // (terminated)
		.csr_read          (1'b0),                                                // (terminated)
		.csr_write         (1'b0),                                                // (terminated)
		.csr_readdata      (),                                                    // (terminated)
	...
	Assignment2_mm_interconnect_0_router router (
	...
	Assignment2_mm_interconnect_0_router router_001 (
	...
	Assignment2_mm_interconnect_0_router_002 router_002 (
		.sink_ready         (fpga_master_agent_cp_ready),                          //      sink.ready
		.sink_valid         (fpga_master_agent_cp_valid),                          //          .valid
		.sink_data          (fpga_master_agent_cp_data),                           //          .data
		.sink_startofpacket (fpga_master_agent_cp_startofpacket),                  //          .startofpacket
		.sink_endofpacket   (fpga_master_agent_cp_endofpacket),                    //          .endofpacket
		.clk                (clk_0_clk_clk),                                       //       clk.clk
		.reset              (onchip_memory2_0_reset1_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	Assignment2_mm_interconnect_0_router_003 router_003 (
	...
	Assignment2_mm_interconnect_0_router_003 router_004 (
	...
	Assignment2_mm_interconnect_0_router_005 router_005 (
	...
	Assignment2_mm_interconnect_0_router_006 router_006 (
	...
	Assignment2_mm_interconnect_0_router_006 router_007 (
		.sink_ready         (led_pio_avalon_slave_0_agent_rp_ready),               //      sink.ready
		.sink_valid         (led_pio_avalon_slave_0_agent_rp_valid),               //          .valid
		.sink_data          (led_pio_avalon_slave_0_agent_rp_data),                //          .data
		.sink_startofpacket (led_pio_avalon_slave_0_agent_rp_startofpacket),       //          .startofpacket
		.sink_endofpacket   (led_pio_avalon_slave_0_agent_rp_endofpacket),         //          .endofpacket
		.clk                (clk_0_clk_clk),                                       //       clk.clk
		.reset              (onchip_memory2_0_reset1_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	Assignment2_mm_interconnect_0_router_006 router_008 (
	...
	altera_merlin_traffic_limiter #(
		...
		.cmd_src_ready          (fpga_master_limiter_cmd_src_ready),                   //   cmd_src.ready
		.cmd_src_data           (fpga_master_limiter_cmd_src_data),                    //          .data
		.cmd_src_channel        (fpga_master_limiter_cmd_src_channel),                 //          .channel
		.cmd_src_startofpacket  (fpga_master_limiter_cmd_src_startofpacket),           //          .startofpacket
		.cmd_src_endofpacket    (fpga_master_limiter_cmd_src_endofpacket),             //          .endofpacket
		...
		.rsp_src_ready          (fpga_master_limiter_rsp_src_ready),                   //   rsp_src.ready
		.rsp_src_valid          (fpga_master_limiter_rsp_src_valid),                   //          .valid
		.rsp_src_data           (fpga_master_limiter_rsp_src_data),                    //          .data
		.rsp_src_channel        (fpga_master_limiter_rsp_src_channel),                 //          .channel
		.rsp_src_startofpacket  (fpga_master_limiter_rsp_src_startofpacket),           //          .startofpacket
		.rsp_src_endofpacket    (fpga_master_limiter_rsp_src_endofpacket),             //          .endofpacket
		.cmd_src_valid          (fpga_master_limiter_cmd_valid_data)                   // cmd_valid.data
	);
	...
	altera_merlin_burst_adapter #(
		...
		.BURSTWRAP_CONST_VALUE     (0),
		.ADAPTER_VERSION           ("13.1")
	) led_pio_avalon_slave_0_burst_adapter (
		.clk                   (clk_0_clk_clk),                                              //       cr0.clk
		.reset                 (onchip_memory2_0_reset1_reset_bridge_in_reset_reset),        // cr0_reset.reset
		...
		.source0_valid         (led_pio_avalon_slave_0_burst_adapter_source0_valid),         //   source0.valid
		.source0_data          (led_pio_avalon_slave_0_burst_adapter_source0_data),          //          .data
		.source0_channel       (led_pio_avalon_slave_0_burst_adapter_source0_channel),       //          .channel
		.source0_startofpacket (led_pio_avalon_slave_0_burst_adapter_source0_startofpacket), //          .startofpacket
		.source0_endofpacket   (led_pio_avalon_slave_0_burst_adapter_source0_endofpacket),   //          .endofpacket
		.source0_ready         (led_pio_avalon_slave_0_burst_adapter_source0_ready)          //          .ready
	);
	...
	Assignment2_mm_interconnect_0_cmd_demux cmd_demux (
		.clk                (clk_0_clk_clk),                                                    //       clk.clk
		.reset              (hps_0_h2f_axi_master_agent_clk_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	Assignment2_mm_interconnect_0_cmd_demux cmd_demux_001 (
		.clk                (clk_0_clk_clk),                                                    //       clk.clk
		.reset              (hps_0_h2f_axi_master_agent_clk_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	Assignment2_mm_interconnect_0_cmd_demux_002 cmd_demux_002 (
		.clk                (clk_0_clk_clk),                                       //        clk.clk
		.reset              (onchip_memory2_0_reset1_reset_bridge_in_reset_reset), //  clk_reset.reset
		.sink_ready         (fpga_master_limiter_cmd_src_ready),                   //       sink.ready
		.sink_channel       (fpga_master_limiter_cmd_src_channel),                 //           .channel
		.sink_data          (fpga_master_limiter_cmd_src_data),                    //           .data
		.sink_startofpacket (fpga_master_limiter_cmd_src_startofpacket),           //           .startofpacket
		.sink_endofpacket   (fpga_master_limiter_cmd_src_endofpacket),             //           .endofpacket
		.sink_valid         (fpga_master_limiter_cmd_valid_data),                  // sink_valid.data
	...
	Assignment2_mm_interconnect_0_cmd_demux_003 cmd_demux_003 (
		.clk                (clk_0_clk_clk),                                                    //        clk.clk
		.reset              (hps_0_h2f_axi_master_agent_clk_reset_reset_bridge_in_reset_reset), //  clk_reset.reset
	...
	Assignment2_mm_interconnect_0_cmd_demux_003 cmd_demux_004 (
		.clk                (clk_0_clk_clk),                                                    //        clk.clk
		.reset              (hps_0_h2f_axi_master_agent_clk_reset_reset_bridge_in_reset_reset), //  clk_reset.reset
	...
	Assignment2_mm_interconnect_0_cmd_mux cmd_mux (
		.clk                 (clk_0_clk_clk),                                                          //       clk.clk
		.reset               (onchip_memory2_0_reset1_reset_bridge_in_reset_reset),                    // clk_reset.reset
		...
		.sink2_ready         (fpga_master_to_onchip_memory2_0_s1_cmd_width_adapter_src_ready),         //     sink2.ready
		.sink2_valid         (fpga_master_to_onchip_memory2_0_s1_cmd_width_adapter_src_valid),         //          .valid
		.sink2_channel       (fpga_master_to_onchip_memory2_0_s1_cmd_width_adapter_src_channel),       //          .channel
		.sink2_data          (fpga_master_to_onchip_memory2_0_s1_cmd_width_adapter_src_data),          //          .data
		.sink2_startofpacket (fpga_master_to_onchip_memory2_0_s1_cmd_width_adapter_src_startofpacket), //          .startofpacket
		.sink2_endofpacket   (fpga_master_to_onchip_memory2_0_s1_cmd_width_adapter_src_endofpacket)    //          .endofpacket
	);

	Assignment2_mm_interconnect_0_cmd_mux_001 cmd_mux_001 (
		.clk                 (clk_0_clk_clk),                                       //       clk.clk
		.reset               (onchip_memory2_0_reset1_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	Assignment2_mm_interconnect_0_cmd_mux_001 cmd_mux_002 (
		.clk                 (clk_0_clk_clk),                                       //       clk.clk
		.reset               (onchip_memory2_0_reset1_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	Assignment2_mm_interconnect_0_cmd_mux_001 cmd_mux_003 (
		.clk                 (clk_0_clk_clk),                                       //       clk.clk
		.reset               (onchip_memory2_0_reset1_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	Assignment2_mm_interconnect_0_rsp_demux rsp_demux (
		.clk                (clk_0_clk_clk),                                       //       clk.clk
		.reset              (onchip_memory2_0_reset1_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	Assignment2_mm_interconnect_0_rsp_demux_001 rsp_demux_001 (
		.clk                (clk_0_clk_clk),                                       //       clk.clk
		.reset              (onchip_memory2_0_reset1_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	Assignment2_mm_interconnect_0_rsp_demux_001 rsp_demux_002 (
		.clk                (clk_0_clk_clk),                                       //       clk.clk
		.reset              (onchip_memory2_0_reset1_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	Assignment2_mm_interconnect_0_rsp_demux_001 rsp_demux_003 (
		.clk                (clk_0_clk_clk),                                       //       clk.clk
		.reset              (onchip_memory2_0_reset1_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	Assignment2_mm_interconnect_0_rsp_mux rsp_mux (
		.clk                 (clk_0_clk_clk),                                                    //       clk.clk
		.reset               (hps_0_h2f_axi_master_agent_clk_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	Assignment2_mm_interconnect_0_rsp_mux rsp_mux_001 (
		.clk                 (clk_0_clk_clk),                                                    //       clk.clk
		.reset               (hps_0_h2f_axi_master_agent_clk_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	Assignment2_mm_interconnect_0_rsp_mux_002 rsp_mux_002 (
		.clk                 (clk_0_clk_clk),                                                          //       clk.clk
		.reset               (onchip_memory2_0_reset1_reset_bridge_in_reset_reset),                    // clk_reset.reset
		...
		.sink0_ready         (onchip_memory2_0_s1_to_fpga_master_rsp_width_adapter_src_ready),         //     sink0.ready
		.sink0_valid         (onchip_memory2_0_s1_to_fpga_master_rsp_width_adapter_src_valid),         //          .valid
		.sink0_channel       (onchip_memory2_0_s1_to_fpga_master_rsp_width_adapter_src_channel),       //          .channel
		.sink0_data          (onchip_memory2_0_s1_to_fpga_master_rsp_width_adapter_src_data),          //          .data
		.sink0_startofpacket (onchip_memory2_0_s1_to_fpga_master_rsp_width_adapter_src_startofpacket), //          .startofpacket
		.sink0_endofpacket   (onchip_memory2_0_s1_to_fpga_master_rsp_width_adapter_src_endofpacket),   //          .endofpacket
	...
	Assignment2_mm_interconnect_0_rsp_mux_003 rsp_mux_003 (
		.clk                 (clk_0_clk_clk),                                                    //       clk.clk
		.reset               (hps_0_h2f_axi_master_agent_clk_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	Assignment2_mm_interconnect_0_rsp_mux_003 rsp_mux_004 (
		.clk                 (clk_0_clk_clk),                                                    //       clk.clk
		.reset               (hps_0_h2f_axi_master_agent_clk_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	altera_merlin_width_adapter #(
	...
	) fpga_master_to_onchip_memory2_0_s1_cmd_width_adapter (
		.clk                  (clk_0_clk_clk),                                                          //       clk.clk
		.reset                (onchip_memory2_0_reset1_reset_bridge_in_reset_reset),                    // clk_reset.reset
		...
		.out_endofpacket      (fpga_master_to_onchip_memory2_0_s1_cmd_width_adapter_src_endofpacket),   //       src.endofpacket
		.out_data             (fpga_master_to_onchip_memory2_0_s1_cmd_width_adapter_src_data),          //          .data
		.out_channel          (fpga_master_to_onchip_memory2_0_s1_cmd_width_adapter_src_channel),       //          .channel
		.out_valid            (fpga_master_to_onchip_memory2_0_s1_cmd_width_adapter_src_valid),         //          .valid
		.out_ready            (fpga_master_to_onchip_memory2_0_s1_cmd_width_adapter_src_ready),         //          .ready
		.out_startofpacket    (fpga_master_to_onchip_memory2_0_s1_cmd_width_adapter_src_startofpacket), //          .startofpacket
	...
	altera_merlin_width_adapter #(
		...
		.PACKING                       (1),
		.ENABLE_ADDRESS_ALIGNMENT      (1)
	) onchip_memory2_0_s1_to_fpga_master_rsp_width_adapter (
		.clk                  (clk_0_clk_clk),                                                          //       clk.clk
		.reset                (onchip_memory2_0_reset1_reset_bridge_in_reset_reset),                    // clk_reset.reset
		...
		.out_endofpacket      (onchip_memory2_0_s1_to_fpga_master_rsp_width_adapter_src_endofpacket),   //       src.endofpacket
		.out_data             (onchip_memory2_0_s1_to_fpga_master_rsp_width_adapter_src_data),          //          .data
		.out_channel          (onchip_memory2_0_s1_to_fpga_master_rsp_width_adapter_src_channel),       //          .channel
		.out_valid            (onchip_memory2_0_s1_to_fpga_master_rsp_width_adapter_src_valid),         //          .valid
		.out_ready            (onchip_memory2_0_s1_to_fpga_master_rsp_width_adapter_src_ready),         //          .ready
		.out_startofpacket    (onchip_memory2_0_s1_to_fpga_master_rsp_width_adapter_src_startofpacket), //          .startofpacket
		.in_command_size_data (3'b000)                                                                  // (terminated)
	);

	Assignment2_mm_interconnect_0_avalon_st_adapter #(
		.inBitsPerSymbol (66),
		.inUsePackets    (0),
		.inDataWidth     (66),
		.inChannelWidth  (0),
	...
	Assignment2_mm_interconnect_0_avalon_st_adapter_001 #(
		.inBitsPerSymbol (34),
		.inUsePackets    (0),
		.inDataWidth     (34),
		.inChannelWidth  (0),
	...
	Assignment2_mm_interconnect_0_avalon_st_adapter_001 #(
		...
		.in_clk_0_clk   (clk_0_clk_clk),                                       // in_clk_0.clk
		.in_rst_0_reset (onchip_memory2_0_reset1_reset_bridge_in_reset_reset), // in_rst_0.reset
		.in_0_data      (led_pio_avalon_slave_0_agent_rdata_fifo_out_data),    //     in_0.data
		.in_0_valid     (led_pio_avalon_slave_0_agent_rdata_fifo_out_valid),   //         .valid
		.in_0_ready     (led_pio_avalon_slave_0_agent_rdata_fifo_out_ready),   //         .ready

...
# ----------------------------------------
# If PRJ_SIM is one of several IP cores in your
...
# ----------------------------------------
# ACDS 17.1 590 win32 2024.07.24.23:39:05
...
alias file_copy {
  echo "\[exec\] file_copy"
  file copy -force $QSYS_SIMDIR/submodules/PRJ_SIM_onchip_memory2_0.hex ./
}
...
ensure_lib                                              ./libraries/ocram_master_0_avalon_slave_0_agent_rsp_fifo/
vmap       ocram_master_0_avalon_slave_0_agent_rsp_fifo ./libraries/ocram_master_0_avalon_slave_0_agent_rsp_fifo/
ensure_lib                                              ./libraries/ocram_master_0_avalon_slave_0_agent/         
vmap       ocram_master_0_avalon_slave_0_agent          ./libraries/ocram_master_0_avalon_slave_0_agent/         
ensure_lib                                              ./libraries/Avalon_Simple_Master_0_avm_m0_agent/         
vmap       Avalon_Simple_Master_0_avm_m0_agent          ./libraries/Avalon_Simple_Master_0_avm_m0_agent/         
ensure_lib                                              ./libraries/onchip_memory2_0_s2_translator/              
vmap       onchip_memory2_0_s2_translator               ./libraries/onchip_memory2_0_s2_translator/              
ensure_lib                                              ./libraries/ocram_master_0_avalon_master_translator/     
vmap       ocram_master_0_avalon_master_translator      ./libraries/ocram_master_0_avalon_master_translator/     
...
ensure_lib                                              ./libraries/ocram_master_0/                              
vmap       ocram_master_0                               ./libraries/ocram_master_0/                              
...
alias com {
  echo "\[exec\] com"
  eval  vlog -sv $USER_DEFINED_VERILOG_COMPILE_OPTIONS $USER_DEFINED_COMPILE_OPTIONS "$QSYS_SIMDIR/submodules/PRJ_SIM_mm_interconnect_1_avalon_st_adapter_error_adapter_0.sv" -work error_adapter_0                             
  eval  vcom $USER_DEFINED_VHDL_COMPILE_OPTIONS $USER_DEFINED_COMPILE_OPTIONS        "$QSYS_SIMDIR/submodules/PRJ_SIM_mm_interconnect_1_avalon_st_adapter.vhd"                -work avalon_st_adapter                           
  eval  vlog -sv $USER_DEFINED_VERILOG_COMPILE_OPTIONS $USER_DEFINED_COMPILE_OPTIONS "$QSYS_SIMDIR/submodules/PRJ_SIM_mm_interconnect_1_rsp_mux.sv"                           -work rsp_mux                                     
  ...
  eval  vlog -sv $USER_DEFINED_VERILOG_COMPILE_OPTIONS $USER_DEFINED_COMPILE_OPTIONS "$QSYS_SIMDIR/submodules/PRJ_SIM_mm_interconnect_1_rsp_demux.sv"                         -work rsp_demux                                   
  eval  vlog -sv $USER_DEFINED_VERILOG_COMPILE_OPTIONS $USER_DEFINED_COMPILE_OPTIONS "$QSYS_SIMDIR/submodules/PRJ_SIM_mm_interconnect_1_cmd_mux.sv"                           -work cmd_mux                                     
  ...
  eval  vlog -sv $USER_DEFINED_VERILOG_COMPILE_OPTIONS $USER_DEFINED_COMPILE_OPTIONS "$QSYS_SIMDIR/submodules/PRJ_SIM_mm_interconnect_1_cmd_demux.sv"                         -work cmd_demux                                   
  eval  vlog -sv $USER_DEFINED_VERILOG_COMPILE_OPTIONS $USER_DEFINED_COMPILE_OPTIONS "$QSYS_SIMDIR/submodules/PRJ_SIM_mm_interconnect_1_router_001.sv"                        -work router_001                                  
  eval  vlog -sv $USER_DEFINED_VERILOG_COMPILE_OPTIONS $USER_DEFINED_COMPILE_OPTIONS "$QSYS_SIMDIR/submodules/PRJ_SIM_mm_interconnect_1_router.sv"                            -work router                                      
  eval  vlog $USER_DEFINED_VERILOG_COMPILE_OPTIONS $USER_DEFINED_COMPILE_OPTIONS     "$QSYS_SIMDIR/submodules/altera_avalon_sc_fifo.v"                                        -work ocram_master_0_avalon_slave_0_agent_rsp_fifo
  eval  vlog -sv $USER_DEFINED_VERILOG_COMPILE_OPTIONS $USER_DEFINED_COMPILE_OPTIONS "$QSYS_SIMDIR/submodules/altera_merlin_slave_agent.sv"                                   -work ocram_master_0_avalon_slave_0_agent         
  eval  vlog -sv $USER_DEFINED_VERILOG_COMPILE_OPTIONS $USER_DEFINED_COMPILE_OPTIONS "$QSYS_SIMDIR/submodules/altera_merlin_burst_uncompressor.sv"                            -work ocram_master_0_avalon_slave_0_agent         
  eval  vlog -sv $USER_DEFINED_VERILOG_COMPILE_OPTIONS $USER_DEFINED_COMPILE_OPTIONS "$QSYS_SIMDIR/submodules/altera_merlin_master_agent.sv"                                  -work Avalon_Simple_Master_0_avm_m0_agent         
  eval  vlog -sv $USER_DEFINED_VERILOG_COMPILE_OPTIONS $USER_DEFINED_COMPILE_OPTIONS "$QSYS_SIMDIR/submodules/altera_merlin_slave_translator.sv"                              -work onchip_memory2_0_s2_translator              
  eval  vlog -sv $USER_DEFINED_VERILOG_COMPILE_OPTIONS $USER_DEFINED_COMPILE_OPTIONS "$QSYS_SIMDIR/submodules/altera_merlin_master_translator.sv"                             -work ocram_master_0_avalon_master_translator     
  ...
  eval  vlog $USER_DEFINED_VERILOG_COMPILE_OPTIONS $USER_DEFINED_COMPILE_OPTIONS     "$QSYS_SIMDIR/submodules/PRJ_SIM_mm_interconnect_1.v"                                    -work mm_interconnect_1                           
  eval  vlog $USER_DEFINED_VERILOG_COMPILE_OPTIONS $USER_DEFINED_COMPILE_OPTIONS     "$QSYS_SIMDIR/submodules/PRJ_SIM_mm_interconnect_0.v"                                    -work mm_interconnect_0                           
  eval  vlog $USER_DEFINED_VERILOG_COMPILE_OPTIONS $USER_DEFINED_COMPILE_OPTIONS     "$QSYS_SIMDIR/submodules/PRJ_SIM_onchip_memory2_0.v"                                     -work onchip_memory2_0                            
  eval  vcom $USER_DEFINED_VHDL_COMPILE_OPTIONS $USER_DEFINED_COMPILE_OPTIONS        "$QSYS_SIMDIR/submodules/CLK_DIVIDER.vhd"                                                -work ocram_master_0                              
  eval  vcom $USER_DEFINED_VHDL_COMPILE_OPTIONS $USER_DEFINED_COMPILE_OPTIONS        "$QSYS_SIMDIR/submodules/OCRAM_MASTER.vhd"                                               -work ocram_master_0                              
  eval  vcom $USER_DEFINED_VHDL_COMPILE_OPTIONS $USER_DEFINED_COMPILE_OPTIONS        "$QSYS_SIMDIR/PRJ_SIM.vhd"                                                                                                                 
  eval  vcom $USER_DEFINED_VHDL_COMPILE_OPTIONS $USER_DEFINED_COMPILE_OPTIONS        "$QSYS_SIMDIR/Tb_PRJ_SIM.vhd"                                                                                                                 
}
...
alias elab {
  echo "\[exec\] elab"
  eval vsim -t ps $ELAB_OPTIONS $USER_DEFINED_ELAB_OPTIONS -L work -L work_lib -L error_adapter_0 -L avalon_st_adapter -L rsp_mux -L rsp_demux -L cmd_mux -L cmd_demux -L router_001 -L router -L ocram_master_0_avalon_slave_0_agent_rsp_fifo -L ocram_master_0_avalon_slave_0_agent -L Avalon_Simple_Master_0_avm_m0_agent -L onchip_memory2_0_s2_translator -L ocram_master_0_avalon_master_translator -L rst_controller -L mm_interconnect_1 -L mm_interconnect_0 -L onchip_memory2_0 -L ocram_master_0 -L altera_ver -L lpm_ver -L sgate_ver -L altera_mf_ver -L altera_lnsim_ver -L cyclonev_ver -L cyclonev_hssi_ver -L cyclonev_pcie_hip_ver -L altera -L lpm -L sgate -L altera_mf -L altera_lnsim -L cyclonev $TOP_LEVEL_NAME
}

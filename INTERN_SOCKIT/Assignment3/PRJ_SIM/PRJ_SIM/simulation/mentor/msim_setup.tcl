...
# ----------------------------------------
# ACDS 17.1 590 win32 2024.07.23.06:32:52
...
ensure_lib                                          ./libraries/avalon_export_0_avs_s0_translator/       
vmap       avalon_export_0_avs_s0_translator        ./libraries/avalon_export_0_avs_s0_translator/       
ensure_lib                                          ./libraries/Avalon_Simple_Master_0_avm_m0_translator/
vmap       Avalon_Simple_Master_0_avm_m0_translator ./libraries/Avalon_Simple_Master_0_avm_m0_translator/
...
alias com {
  echo "\[exec\] com"
  eval  vlog -sv $USER_DEFINED_VERILOG_COMPILE_OPTIONS $USER_DEFINED_COMPILE_OPTIONS "$QSYS_SIMDIR/submodules/altera_merlin_slave_translator.sv"  -work avalon_export_0_avs_s0_translator       
  eval  vlog -sv $USER_DEFINED_VERILOG_COMPILE_OPTIONS $USER_DEFINED_COMPILE_OPTIONS "$QSYS_SIMDIR/submodules/altera_merlin_master_translator.sv" -work Avalon_Simple_Master_0_avm_m0_translator
  ...
  eval  vcom $USER_DEFINED_VHDL_COMPILE_OPTIONS $USER_DEFINED_COMPILE_OPTIONS        "$QSYS_SIMDIR/CLK_DIVIDER.vhd"                                                                                 
  eval  vcom $USER_DEFINED_VHDL_COMPILE_OPTIONS $USER_DEFINED_COMPILE_OPTIONS        "$QSYS_SIMDIR/FIFO.vhd"                                                                                 
  eval  vcom $USER_DEFINED_VHDL_COMPILE_OPTIONS $USER_DEFINED_COMPILE_OPTIONS        "$QSYS_SIMDIR/FIFO_CTRL.vhd"                                                                                 
...
alias elab {
  echo "\[exec\] elab"
  eval vsim -t ps $ELAB_OPTIONS $USER_DEFINED_ELAB_OPTIONS -L work -L work_lib -L avalon_export_0_avs_s0_translator -L Avalon_Simple_Master_0_avm_m0_translator -L rst_controller -L mm_interconnect_0 -L altera_ver -L lpm_ver -L sgate_ver -L altera_mf_ver -L altera_lnsim_ver -L cyclonev_ver -L cyclonev_hssi_ver -L cyclonev_pcie_hip_ver -L altera -L lpm -L sgate -L altera_mf -L altera_lnsim -L cyclonev $TOP_LEVEL_NAME
}
...
alias elab_debug {
  ...
  eval vsim -novopt -t ps $ELAB_OPTIONS $USER_DEFINED_ELAB_OPTIONS -L work -L work_lib -L avalon_export_0_avs_s0_translator -L Avalon_Simple_Master_0_avm_m0_translator -L rst_controller -L mm_interconnect_0 -L altera_ver -L lpm_ver -L sgate_ver -L altera_mf_ver -L altera_lnsim_ver -L cyclonev_ver -L cyclonev_hssi_ver -L cyclonev_pcie_hip_ver -L altera -L lpm -L sgate -L altera_mf -L altera_lnsim -L cyclonev $TOP_LEVEL_NAME
}

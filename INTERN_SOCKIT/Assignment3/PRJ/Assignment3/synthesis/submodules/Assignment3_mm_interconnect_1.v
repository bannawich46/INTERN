// Assignment3_mm_interconnect_1.v
...
`timescale 1 ps / 1 ps
module Assignment3_mm_interconnect_1 (
	...
	Assignment3_mm_interconnect_1_router router (
	...
	Assignment3_mm_interconnect_1_router_001 router_001 (
	...
	Assignment3_mm_interconnect_1_router_001 router_002 (
	...
	Assignment3_mm_interconnect_1_cmd_demux cmd_demux (
		.clk                (clk_0_clk_clk),                                           //        clk.clk
		.reset              (hps_master_translator_reset_reset_bridge_in_reset_reset), //  clk_reset.reset
	...
	Assignment3_mm_interconnect_1_cmd_mux cmd_mux (
		.clk                 (clk_0_clk_clk),                                                    //       clk.clk
		.reset               (hps_0_f2h_axi_slave_agent_reset_sink_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	Assignment3_mm_interconnect_1_cmd_mux cmd_mux_001 (
		.clk                 (clk_0_clk_clk),                                                    //       clk.clk
		.reset               (hps_0_f2h_axi_slave_agent_reset_sink_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	Assignment3_mm_interconnect_1_rsp_demux rsp_demux (
		.clk                (clk_0_clk_clk),                                                    //       clk.clk
		.reset              (hps_0_f2h_axi_slave_agent_reset_sink_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	Assignment3_mm_interconnect_1_rsp_demux rsp_demux_001 (
		.clk                (clk_0_clk_clk),                                                    //       clk.clk
		.reset              (hps_0_f2h_axi_slave_agent_reset_sink_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	Assignment3_mm_interconnect_1_rsp_mux rsp_mux (
		.clk                 (clk_0_clk_clk),                                           //       clk.clk
		.reset               (hps_master_translator_reset_reset_bridge_in_reset_reset), // clk_reset.reset

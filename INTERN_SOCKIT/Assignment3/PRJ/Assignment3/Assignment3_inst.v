	Assignment3 u0 (
		.avalon_export_0_avs_s0_address       (<connected-to-avalon_export_0_avs_s0_address>),       //    avalon_export_0_avs_s0.address
		.avalon_export_0_avs_s0_read          (<connected-to-avalon_export_0_avs_s0_read>),          //                          .read
		.avalon_export_0_avs_s0_readdata      (<connected-to-avalon_export_0_avs_s0_readdata>),      //                          .readdata
		.avalon_export_0_avs_s0_write         (<connected-to-avalon_export_0_avs_s0_write>),         //                          .write
		.avalon_export_0_avs_s0_writedata     (<connected-to-avalon_export_0_avs_s0_writedata>),     //                          .writedata
		.avalon_export_0_avs_s0_waitrequest   (<connected-to-avalon_export_0_avs_s0_waitrequest>),   //                          .waitrequest
		.avalon_export_0_reset_reset          (<connected-to-avalon_export_0_reset_reset>),          //     avalon_export_0_reset.reset

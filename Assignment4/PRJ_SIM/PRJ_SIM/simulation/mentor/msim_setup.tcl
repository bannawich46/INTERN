...
# ----------------------------------------
# ACDS 17.1 590 win32 2024.06.19.08:55:43
...
alias com {
  ...
  eval  vlog $USER_DEFINED_VERILOG_COMPILE_OPTIONS $USER_DEFINED_COMPILE_OPTIONS     "$QSYS_SIMDIR/submodules/PRJ_SIM_pio_0.v"                    -work pio_0                                 
...
alias elab_debug {
  ...
  eval vsim -novopt -t ps $ELAB_OPTIONS $USER_DEFINED_ELAB_OPTIONS -L work -L work_lib -L pio_0_s1_translator -L AvalonSimpleMaster_0_avm_m0_translator -L rst_controller -L mm_interconnect_0 -L pio_0 -L altera_ver -L lpm_ver -L sgate_ver -L altera_mf_ver -L altera_lnsim_ver -L fiftyfivenm_ver -L altera -L lpm -L sgate -L altera_mf -L altera_lnsim -L fiftyfivenm $TOP_LEVEL_NAME
}

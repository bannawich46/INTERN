...
module Assignment4_mm_interconnect_0 (
	...
	wire  [106:0] pio_0_avalon_slave_0_agent_rf_source_data;                                          // pio_0_avalon_slave_0_agent:rf_source_data -> pio_0_avalon_slave_0_agent_rsp_fifo:in_data
	...
	wire  [106:0] pio_0_avalon_slave_0_agent_rsp_fifo_out_data;                                       // pio_0_avalon_slave_0_agent_rsp_fifo:out_data -> pio_0_avalon_slave_0_agent:rf_sink_data
	...
	wire  [105:0] cmd_mux_001_src_data;                                                               // cmd_mux_001:src_data -> pio_0_avalon_slave_0_agent:cp_data
	wire          cmd_mux_001_src_ready;                                                              // pio_0_avalon_slave_0_agent:cp_ready -> cmd_mux_001:src_ready
	wire    [3:0] cmd_mux_001_src_channel;                                                            // cmd_mux_001:src_channel -> pio_0_avalon_slave_0_agent:cp_channel
	...
	wire  [105:0] pio_0_avalon_slave_0_agent_rp_data;                                                 // pio_0_avalon_slave_0_agent:rp_data -> router_004:sink_data
	...
	Assignment4_mm_interconnect_0_cmd_mux_002 cmd_mux_002 (
		.clk                 (clk_0_clk_clk),                                  //       clk.clk
		.reset               (nios2_gen2_0_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	Assignment4_mm_interconnect_0_cmd_mux_002 cmd_mux_003 (
		.clk                 (clk_0_clk_clk),                                  //       clk.clk
		.reset               (nios2_gen2_0_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	Assignment4_mm_interconnect_0_rsp_demux_002 rsp_demux_002 (
		.clk                (clk_0_clk_clk),                                  //       clk.clk
		.reset              (nios2_gen2_0_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	Assignment4_mm_interconnect_0_rsp_demux_002 rsp_demux_003 (
		.clk                (clk_0_clk_clk),                                  //       clk.clk
		.reset              (nios2_gen2_0_reset_reset_bridge_in_reset_reset), // clk_reset.reset

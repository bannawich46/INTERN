...
# ----------------------------------------
# ACDS 17.1 590 win32 2024.07.01.23:36:34
...
ensure_lib                                        ./libraries/PWM_0_avalon_slave_0_translator/       
vmap       PWM_0_avalon_slave_0_translator        ./libraries/PWM_0_avalon_slave_0_translator/       
...
alias com {
  echo "\[exec\] com"
  eval  vlog -sv $USER_DEFINED_VERILOG_COMPILE_OPTIONS $USER_DEFINED_COMPILE_OPTIONS "$QSYS_SIMDIR/submodules/altera_merlin_slave_translator.sv"  -work PWM_0_avalon_slave_0_translator       
...
alias elab {
  echo "\[exec\] elab"
  eval vsim -t ps $ELAB_OPTIONS $USER_DEFINED_ELAB_OPTIONS -L work -L work_lib -L PWM_0_avalon_slave_0_translator -L AvalonSimpleMaster_0_avm_m0_translator -L rst_controller -L mm_interconnect_0 -L PWM_0 -L altera_ver -L lpm_ver -L sgate_ver -L altera_mf_ver -L altera_lnsim_ver -L fiftyfivenm_ver -L altera -L lpm -L sgate -L altera_mf -L altera_lnsim -L fiftyfivenm $TOP_LEVEL_NAME
}
...
alias elab_debug {
  ...
  eval vsim -novopt -t ps $ELAB_OPTIONS $USER_DEFINED_ELAB_OPTIONS -L work -L work_lib -L PWM_0_avalon_slave_0_translator -L AvalonSimpleMaster_0_avm_m0_translator -L rst_controller -L mm_interconnect_0 -L PWM_0 -L altera_ver -L lpm_ver -L sgate_ver -L altera_mf_ver -L altera_lnsim_ver -L fiftyfivenm_ver -L altera -L lpm -L sgate -L altera_mf -L altera_lnsim -L fiftyfivenm $TOP_LEVEL_NAME
}

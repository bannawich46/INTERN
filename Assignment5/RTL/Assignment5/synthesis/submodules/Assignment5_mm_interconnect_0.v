// Assignment5_mm_interconnect_0.v
...
`timescale 1 ps / 1 ps
module Assignment5_mm_interconnect_0 (
	...
	wire  [106:0] pwm_0_avalon_slave_0_agent_rf_source_data;                                          // PWM_0_avalon_slave_0_agent:rf_source_data -> PWM_0_avalon_slave_0_agent_rsp_fifo:in_data
	...
	wire  [106:0] pwm_0_avalon_slave_0_agent_rsp_fifo_out_data;                                       // PWM_0_avalon_slave_0_agent_rsp_fifo:out_data -> PWM_0_avalon_slave_0_agent:rf_sink_data
	...
	wire  [105:0] cmd_mux_001_src_data;                                                               // cmd_mux_001:src_data -> PWM_0_avalon_slave_0_agent:cp_data
	...
	wire  [105:0] pwm_0_avalon_slave_0_agent_rp_data;                                                 // PWM_0_avalon_slave_0_agent:rp_data -> router_004:sink_data
	...
	Assignment5_mm_interconnect_0_router router (
	...
	Assignment5_mm_interconnect_0_router router_001 (
	...
	Assignment5_mm_interconnect_0_router_002 router_002 (
	...
	Assignment5_mm_interconnect_0_router_003 router_003 (
	...
	Assignment5_mm_interconnect_0_router_003 router_004 (
	...
	Assignment5_mm_interconnect_0_router_005 router_005 (
	...
	Assignment5_mm_interconnect_0_router_005 router_006 (
	...
	Assignment5_mm_interconnect_0_cmd_demux cmd_demux (
		.clk                (clk_0_clk_clk),                                  //       clk.clk
		.reset              (nios2_gen2_0_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	Assignment5_mm_interconnect_0_cmd_demux_001 cmd_demux_001 (
		.clk                (clk_0_clk_clk),                                  //        clk.clk
		.reset              (nios2_gen2_0_reset_reset_bridge_in_reset_reset), //  clk_reset.reset
	...
	Assignment5_mm_interconnect_0_cmd_demux_002 cmd_demux_002 (
		.clk                (clk_0_clk_clk),                                  //       clk.clk
		.reset              (nios2_gen2_0_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	Assignment5_mm_interconnect_0_cmd_mux cmd_mux (
		.clk                 (clk_0_clk_clk),                                  //       clk.clk
		.reset               (nios2_gen2_0_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	Assignment5_mm_interconnect_0_cmd_mux cmd_mux_001 (
		.clk                 (clk_0_clk_clk),                                  //       clk.clk
		.reset               (nios2_gen2_0_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	Assignment5_mm_interconnect_0_cmd_mux_002 cmd_mux_002 (
		.clk                 (clk_0_clk_clk),                                  //       clk.clk
		.reset               (nios2_gen2_0_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	Assignment5_mm_interconnect_0_cmd_mux_002 cmd_mux_003 (
		.clk                 (clk_0_clk_clk),                                  //       clk.clk
		.reset               (nios2_gen2_0_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	Assignment5_mm_interconnect_0_cmd_demux_002 rsp_demux (
		.clk                (clk_0_clk_clk),                                  //       clk.clk
		.reset              (nios2_gen2_0_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	Assignment5_mm_interconnect_0_cmd_demux_002 rsp_demux_001 (
		.clk                (clk_0_clk_clk),                                  //       clk.clk
		.reset              (nios2_gen2_0_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	Assignment5_mm_interconnect_0_rsp_demux_002 rsp_demux_002 (
		.clk                (clk_0_clk_clk),                                  //       clk.clk
		.reset              (nios2_gen2_0_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	Assignment5_mm_interconnect_0_rsp_demux_002 rsp_demux_003 (
		.clk                (clk_0_clk_clk),                                  //       clk.clk
		.reset              (nios2_gen2_0_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	Assignment5_mm_interconnect_0_rsp_mux rsp_mux (
		.clk                 (clk_0_clk_clk),                                  //       clk.clk
		.reset               (nios2_gen2_0_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	Assignment5_mm_interconnect_0_rsp_mux rsp_mux_001 (
		.clk                 (clk_0_clk_clk),                                  //       clk.clk
		.reset               (nios2_gen2_0_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	Assignment5_mm_interconnect_0_rsp_mux_002 rsp_mux_002 (
		.clk                 (clk_0_clk_clk),                                  //       clk.clk
		.reset               (nios2_gen2_0_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	Assignment5_mm_interconnect_0_avalon_st_adapter #(
		.inBitsPerSymbol (34),
		.inUsePackets    (0),
		.inDataWidth     (34),
		.inChannelWidth  (0),

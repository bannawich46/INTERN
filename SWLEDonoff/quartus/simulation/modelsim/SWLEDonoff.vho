...
-- SW0	=>  Location: PIN_J21,	 I/O Standard: 1.5 V Schmitt Trigger,	 Current Strength: Default
...
ARCHITECTURE structure OF SWLEDonoff IS
SIGNAL gnd : std_logic := '0';
SIGNAL vcc : std_logic := '1';
SIGNAL unknown : std_logic := 'X';
...
SIGNAL \LED0_State~1_combout\ : std_logic;
SIGNAL \Stop~q\ : std_logic;
SIGNAL \LED0_State~0_combout\ : std_logic;
SIGNAL \LED0_State~q\ : std_logic;
SIGNAL \ALT_INV_LED0_State~q\ : std_logic;
...
\ALT_INV_LED0_State~q\ <= NOT \LED0_State~q\;
...
\LED0_State~1\ : fiftyfivenm_lcell_comb
-- Equation(s):
-- \LED0_State~1_combout\ = (\Stop~q\) # (!\Rst~input_o\)
...
PORT MAP (
	...
	d => \LED0_State~1_combout\,
	devclrn => ww_devclrn,
	devpor => ww_devpor,
	q => \Stop~q\);

-- Location: LCCOMB_X77_Y30_N0
\LED0_State~0\ : fiftyfivenm_lcell_comb
-- Equation(s):
-- \LED0_State~0_combout\ = (\Rst~input_o\ & (\SW0~input_o\ & ((!\Stop~q\)))) # (!\Rst~input_o\ & (((\LED0_State~q\))))

...
module Assignment3_mm_interconnect_0 (
	...
	wire  [101:0] cmd_mux_001_src_data;                                                               // cmd_mux_001:src_data -> onchip_flash_0_csr_agent:cp_data
	wire          cmd_mux_001_src_ready;                                                              // onchip_flash_0_csr_agent:cp_ready -> cmd_mux_001:src_ready
	wire    [6:0] cmd_mux_001_src_channel;                                                            // cmd_mux_001:src_channel -> onchip_flash_0_csr_agent:cp_channel
	...
	wire  [101:0] cmd_mux_002_src_data;                                                               // cmd_mux_002:src_data -> onchip_flash_0_data_agent:cp_data
	wire          cmd_mux_002_src_ready;                                                              // onchip_flash_0_data_agent:cp_ready -> cmd_mux_002:src_ready
	wire    [6:0] cmd_mux_002_src_channel;                                                            // cmd_mux_002:src_channel -> onchip_flash_0_data_agent:cp_channel
	...
	wire   [22:0] sw_pio_s1_agent_m0_address;                                                         // sw_pio_s1_agent:m0_address -> sw_pio_s1_translator:uav_address
	...
	wire  [102:0] sw_pio_s1_agent_rf_source_data;                                                     // sw_pio_s1_agent:rf_source_data -> sw_pio_s1_agent_rsp_fifo:in_data
	...
	wire  [102:0] sw_pio_s1_agent_rsp_fifo_out_data;                                                  // sw_pio_s1_agent_rsp_fifo:out_data -> sw_pio_s1_agent:rf_sink_data
	...
	wire  [101:0] cmd_mux_005_src_data;                                                               // cmd_mux_005:src_data -> sw_pio_s1_agent:cp_data
	...
	wire  [101:0] cmd_mux_006_src_data;                                                               // cmd_mux_006:src_data -> led_pio_s1_agent:cp_data
	...
	wire  [101:0] onchip_flash_0_csr_agent_rp_data;                                                   // onchip_flash_0_csr_agent:rp_data -> router_003:sink_data
	...
	wire  [101:0] onchip_flash_0_data_agent_rp_data;                                                  // onchip_flash_0_data_agent:rp_data -> router_004:sink_data
	...
	wire  [101:0] sw_pio_s1_agent_rp_data;                                                            // sw_pio_s1_agent:rp_data -> router_007:sink_data
	...
	wire  [101:0] led_pio_s1_agent_rp_data;                                                           // led_pio_s1_agent:rp_data -> router_008:sink_data
	...
	wire  [101:0] cmd_demux_001_src4_data;                                                            // cmd_demux_001:src4_data -> cmd_mux_006:sink1_data
	...
	wire  [101:0] rsp_demux_006_src1_data;                                                            // rsp_demux_006:src1_data -> rsp_mux_001:sink4_data
	...
	Assignment3_mm_interconnect_0_router_001 router_001 (
	...
	Assignment3_mm_interconnect_0_router_002 router_003 (
	...
	Assignment3_mm_interconnect_0_router_004 router_004 (
	...
	Assignment3_mm_interconnect_0_router_004 router_005 (
	...
	Assignment3_mm_interconnect_0_router_004 router_006 (
	...
	Assignment3_mm_interconnect_0_router_004 router_007 (
	...
	Assignment3_mm_interconnect_0_router_004 router_008 (
	...
	Assignment3_mm_interconnect_0_cmd_demux_001 cmd_demux_001 (
		.clk                (clk_0_clk_clk),                                  //       clk.clk
		.reset              (nios2_gen2_0_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	Assignment3_mm_interconnect_0_cmd_mux_002 cmd_mux_002 (
		.clk                 (clk_0_clk_clk),                                  //       clk.clk
		.reset               (nios2_gen2_0_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	Assignment3_mm_interconnect_0_cmd_mux_002 cmd_mux_003 (
		.clk                 (clk_0_clk_clk),                                  //       clk.clk
		.reset               (nios2_gen2_0_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	Assignment3_mm_interconnect_0_cmd_mux_002 cmd_mux_004 (
		.clk                 (clk_0_clk_clk),                                  //       clk.clk
		.reset               (nios2_gen2_0_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	Assignment3_mm_interconnect_0_cmd_mux_002 cmd_mux_005 (
		.clk                 (clk_0_clk_clk),                                  //       clk.clk
		.reset               (nios2_gen2_0_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	Assignment3_mm_interconnect_0_cmd_mux_002 cmd_mux_006 (
		.clk                 (clk_0_clk_clk),                                  //       clk.clk
		.reset               (nios2_gen2_0_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	Assignment3_mm_interconnect_0_rsp_demux_002 rsp_demux_002 (
		.clk                (clk_0_clk_clk),                                  //       clk.clk
		.reset              (nios2_gen2_0_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	Assignment3_mm_interconnect_0_rsp_demux_002 rsp_demux_003 (
		.clk                (clk_0_clk_clk),                                  //       clk.clk
		.reset              (nios2_gen2_0_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	Assignment3_mm_interconnect_0_rsp_demux_002 rsp_demux_004 (
		.clk                (clk_0_clk_clk),                                  //       clk.clk
		.reset              (nios2_gen2_0_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	Assignment3_mm_interconnect_0_rsp_demux_002 rsp_demux_005 (
		.clk                (clk_0_clk_clk),                                  //       clk.clk
		.reset              (nios2_gen2_0_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	Assignment3_mm_interconnect_0_rsp_demux_002 rsp_demux_006 (
		.clk                (clk_0_clk_clk),                                  //       clk.clk
		.reset              (nios2_gen2_0_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	Assignment3_mm_interconnect_0_rsp_mux_001 rsp_mux_001 (
		.clk                 (clk_0_clk_clk),                                  //       clk.clk
		.reset               (nios2_gen2_0_reset_reset_bridge_in_reset_reset), // clk_reset.reset
